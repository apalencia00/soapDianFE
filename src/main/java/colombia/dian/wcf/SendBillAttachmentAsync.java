...
/**
 *  SendBillAttachmentAsync bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SendBillAttachmentAsync implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://wcf.dian.colombia",
            "SendBillAttachmentAsync", "ns10");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SendBillAttachmentAsync", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SendBillAttachmentAsync", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SendBillAttachmentAsync parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SendBillAttachmentAsync object = new SendBillAttachmentAsync();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SendBillAttachmentAsync".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SendBillAttachmentAsync) colombia.dian.wcf.imports.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
