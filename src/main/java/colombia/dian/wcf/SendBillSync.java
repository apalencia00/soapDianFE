...
/**
 *  SendBillSync bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SendBillSync implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SendBillSync", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SendBillSync", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SendBillSync parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SendBillSync object = new SendBillSync();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SendBillSync".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SendBillSync) colombia.dian.wcf.imports.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
