...
/**
 *  SendBillAsync bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SendBillAsync implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":SendBillAsync", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "SendBillAsync", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SendBillAsync parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SendBillAsync object = new SendBillAsync();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SendBillAsync".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SendBillAsync) colombia.dian.wcf.imports.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
